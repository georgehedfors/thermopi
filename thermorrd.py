...
def create_rrd():
    return rrdtool.create(rrdb, "--step", "300", 
        "DS:temp1:GAUGE:900:0:300", 
        "DS:temp2:GAUGE:900:0:300", 
        "RRA:MAX:0.5:1:288")

def update_rrd():
    return rrdtool.update(rrdb, "N:%s:%s" % thermopi.get_temp())
...
def graph_rrd():
    return rrdtool.graph("/var/www/html/thermopi/temperature.png", 
        ...
        "-w 640",
        "DEF:temp1=%s:temp1:MAX" % rrdb,
        "DEF:temp2=%s:temp2:MAX" % rrdb,
